...
class ContentScript {
   ...
   * @param {message} message received from background script.
   */
  onMessage(message) {
   ...
   * @param {mutation} mutation comited on content script store.
   */
   ...
   * @param {mutation} mutation object to send to background script.
   */
